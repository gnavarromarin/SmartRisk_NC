...
st.set_page_config(
    ...
    # page_icon="https://github.com/lauridangut/SmartRisk/blob/main/data/utilities/Logo_solo_esfera.png"
)
# st.sidebar.image("data\utilities\Logo_completo.png", width=200)
st.header('Plataforma para la identificación de clientes con riesgo de incumplimiento de pago en solicitudes de crédito')
